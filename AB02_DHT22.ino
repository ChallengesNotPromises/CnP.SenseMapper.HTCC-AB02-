...
/* OTAA para*/
uint8_t devEui[] = { 0x60, 0x81, 0xF9, 0x6A, 0x79, 0x6B, 0x22, 0x06 };
uint8_t appEui[] = { 0x60, 0x81, 0xF9, 0xEE, 0x4F, 0xB5, 0xC8, 0xFE };
uint8_t appKey[] = { 0x60, 0x1A, 0x87, 0xA7, 0x03, 0x81, 0xFC, 0x9E, 0xD7, 0x3E, 0x76, 0x34, 0xD6, 0xC3, 0xD9, 0xAB };
